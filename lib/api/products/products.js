...
var Products = function () {
	...
	_createClass(Products, [{
		key: 'discounted',
		value: function discounted(filter) {
			return this.client.get(this.resourceUrl + '/discounted', filter);
		}
	}, {
		key: 'bestSellers',
		value: function bestSellers(filter) {
			return this.client.get(this.resourceUrl + '/best_sellers', filter);
		}
	}, {
		key: 'list',

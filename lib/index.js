...
var _blogs = require('./api/blogs/blogs');

var _blogs2 = _interopRequireDefault(_blogs);

var _images3 = require('./api/blogs/images');

var _images4 = _interopRequireDefault(_images3);

var _pictures = require('./api/pictures/pictures');

var _pictures2 = _interopRequireDefault(_pictures);

var _images5 = require('./api/pictures/images');

var _images6 = _interopRequireDefault(_images5);
...
var _ajaxMessage = require('./api/ajaxMessage');

var _ajaxMessage2 = _interopRequireDefault(_ajaxMessage);

var _ajaxUserRequest = require('./api/ajaxUserRequest');

var _ajaxUserRequest2 = _interopRequireDefault(_ajaxUserRequest);
...
var Client = function Client() {
	...
	var ajaxClient = new _ajaxClient2.default({
	...
	this.blogs = new _blogs2.default(apiClient);
	this.blogs.images = new _images4.default(apiClient);
	this.pictures = new _pictures2.default(apiClient);
	this.pictures.images = new _images6.default(apiClient);
	...
	this.ajax = {};
	this.ajax.blogs = new _blogs2.default(ajaxClient);
	this.ajax.pictures = new _pictures2.default(ajaxClient);
	...
	this.ajax.message = new _ajaxMessage2.default(ajaxClient);
	this.ajax.userRequest = new _ajaxUserRequest2.default(ajaxClient);
